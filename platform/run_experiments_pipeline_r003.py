...
def generate_candidate_config(config_name):
    ...
    candidate_path = ROOT / "configs" / "generated" / f"{config_name}_candidate_r003.yaml"
...
def main():
    ...
    for config_name in configs_to_test:
        ...
        candidate_metrics = get_cache(config_name, "candidate_r003")
        ...
        if baseline_metrics and candidate_metrics:
            ...
            exp_name = f"{config_name}_exp_r003"
            cmd = [
            ...
            set_cache(config_name, "candidate_r003", candidate_metrics)
    ...
    print("\n\n" + "="*50)
    print(" EXPERIMENT RESULTS COMPARISON SUMMARY (R003) ")
    print("="*50)
