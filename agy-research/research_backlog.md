...
| :--- | :--- | :--- | :--- | :--- | :--- |
| R005 | 引入黑天鹅防范与极端风险度量的 CVaR 风险平价策略 | 传统风险平价基于正态分布假设，忽略极端尾部风险。拟将风险度量升级为条件风险价值（CVaR/Expected Shortfall），通过历史模拟/半参数法计算资产对组合的边际 CVaR 贡献，使尾部风险均等化以防御市场极端冲击。 | High | 各 ETF 历史日度收盘价数据 | `platform/configs/baseline_r3_global_nasdaq_all_weather_ewma.yaml` |
