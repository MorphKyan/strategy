...
.\env\python.exe platform\scripts\run_sim_portfolio.py --config configs\platform_m3m4.yaml --checkpoint platform\results\platform_sim_portfolio\checkpoint.json --asof-date 2026-05-30
```
